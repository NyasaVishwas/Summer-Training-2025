...
function App() {
  ...
  return (
    <div>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100">
        <div className='bg-white shadow-lg rounded-xl p-8 text-center w-80'>
          ...
          <div className='flex justify-between'>
            ...
            <button onClick={reset} className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition'>
              Reset
            </button>
